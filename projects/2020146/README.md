...
Η HyperCard είναι μια εφαρμογή λογισμικού και development kit για Apple Macintosh. 
Είναι από τα πρώτα επιτυχημένα συστήματα υπερμέσων που προηγήθηκαν του Παγκόσμιου Ιστού. 
Συνδυάζει μια βάση δεδομένων επίπεδων αρχείων με μια γραφική, 
ευέλικτη διεπαφή που μπορεί να τροποποιηθεί από το χρήστη. 
Η HyperCard περιλαμβάνει μια ενσωματωμένη γλώσσα προγραμματισμού
