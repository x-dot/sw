...
| 2 | [Γραμμή Εντολών](https://epidrome.github.io/teaching/cli) (Systemd) και [διαδικασία συνεργασίας με pull request στον οργανισμό της ομάδας σας](https://epidrome.github.io/teaching/team) | [Παραδοτέο 2](https://github.com/x-dot/sw/blob/2020146/projects/2020146/README.md#%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%B5%CE%BF-2--%CE%B3%CF%81%CE%B1%CE%BC%CE%BC%CE%B7-%CE%B5%CE%BD%CF%84%CE%BF%CE%BB%CF%8E%CE%BD-systemd)| |
| 3 | Γραμμή Εντολών (No systemd) |[Παραδοτέο 3](https://github.com/x-dot/sw/blob/2020146/projects/2020146/README.md#%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%B5%CE%BF-3--%CE%B3%CF%81%CE%B1%CE%BC%CE%BC%CE%AE-%CE%B5%CE%BD%CF%84%CE%BF%CE%BB%CF%8E%CE%BD-no-systemd)|  Δεν αντιμετώπισα σοβαρά προβλήματα εκτός κάποιον πακέτων που δεν ήταν αρχικά εγκατεστημένα, τα οποία εγκατέστησα με την εντολή sudo pacman -S *package*. |
| 4 | Κατασκευή του Βιβλίου Α2 (Συνεργατικά) | [Παραδοτέο 4](https://github.com/x-dot/sw/blob/2020146/projects/2020146/README.md#%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%B5%CE%BF-4--%CE%BA%CE%B1%CF%84%CE%B1%CF%83%CE%BA%CE%B5%CF%85%CE%AE-%CF%84%CE%BF%CF%85-%CE%B2%CE%B9%CE%B2%CE%BB%CE%AF%CE%BF%CF%85-%CE%B12-%CF%83%CF%85%CE%BD%CE%B5%CF%81%CE%B3%CE%B1%CF%84%CE%B9%CE%BA%CE%AC) | Έκανα την δημιουργία της υποσημείωσης και το pdf του βιβλίου όμως είχα κάνει λάθος git clone και στο τέλος δεν μπορούσα να κάνω add τα καινούρια αρχεία. Αυτό είναι κάτι που θα διορθωθεί στις επόμενες ημέρες, κάνοντας το σωστό git clone των περιεχομένων του βιβλίου και κάνοντας ουσιαστικά όλη την διαδικασία απο την αρχή. |
| 5 | Συμμετοχικό Περιεχόμενο A1 + A2 | [Παραδοτέο 5](https://github.com/x-dot/sw/blob/2020146/projects/2020146/README.md#%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%B5%CE%BF-5--%CF%83%CF%85%CE%BC%CE%BC%CE%B5%CF%84%CE%BF%CF%87%CE%B9%CE%BA%CF%8C-%CF%80%CE%B5%CF%81%CE%B9%CE%B5%CF%87%CF%8C%CE%BC%CE%B5%CE%BD%CE%BF-a1--a2) | |
...
Για το δεύτερο παραδοτέο χρησιμοποίησα τα Kali linux. Τα Kali linux είναι ενα distribution των linux που βασίστηκαν στο debian και έχουν σαν pack manager το apt. Tα Kali χρησιμοποιούν το systemd σαν deamon των διεργασιών τους. Το systemd είναι μια σουίτα λογισμικού που παρέχει μια σειρά απο στοιχεία συστήματος για λειτουργικά συστήματα Linux. Προτεύων στόχος του είναι να διαχειρίζεται το σύστημα, τις υπηρεσίες και να ενοποιεί διεργασίες. Είναι ένα σύστημα init που χρησιμοποιείται για την εκκίνηση και την διαχείριση των διαδικασιών χρήστη. Ακόμη, παρέχει αντικαταστάσεις για διάφορα deamons και βοηθητικά προγράμματα όπως διαχείριση συσκευών, σύνδεσης δικτύου και καταγραφής συμβάντων. Έπειτα, για άσκηση γραμμής εντολών δημιουργήθηκε ένα πρόγραμμα σε bash το οποίο με ενημερώνει αν η τιμή του Facebook stock παραμένει κάτω απο τα 200 USD.Αρχικά έχουμε μια δομή επανάληψης. Εκχωρούμε την τιμή του Facebook stock στην μεταβλητή fb_price μέσω του cURL (client URL). To curl είναι ένα open source command line tool και crossplatform library(libcurl), χρησιμοποιείται για την μεταφορά δεδομένων μεταξύ server, διανέμοντάς τα σε όλα τα λειτουργικά συστήματα. Χρησιμοποιείται το api του finance.yahoo για να πάρουμε την τιμή του fb interval. Το flag -s κάνει την εντολή να είναι πιο ήσυχη και αποτελεσματική μειώνοντας κάθε output που δεν είναι απαραίτητο στην διαδικασία της μεταφοράς. Έπειτα χρησιμοποιούμε την εντολή jq pipeline για να κάνει extract συγκεκριμένη πληροφορία απο τα json αρχεία και στην περίπτωσή μας να κάνει extract την regular market price και ύστερα αποθηκεύει το αποτέλεσμα, δηλαδή την τιμή fb_price. Στο επόμενο στάδιο δίνουμε εντολή στο ntfy να στείλει μήνυμα στο telegram μέσω backend (-b). Τέλος, περιμένει 50 δευτερόλεπτα και ξαναξεκινάει. Το πρόγραμμα τρέχει με τον εντολή bash -x noti2.sh γιατί μας επιτρέπει να δούμε όλη την διαδικασία του script εντολή προς εντολή και σε περίπτωση που αντιμετωπήσει κάποιο error να το δούμε σε real-time.


<img src="https://user-images.githubusercontent.com/59845451/224355511-2829ee38-3f46-4dc8-a295-a3c26d146637.jpg" width="375">
...
Για το τέταρτο παραδοτέο έκανα μια υποσημείωση στο 6ο κεφάλαιο σχετικά με τη HyperCard.

- Screenshot του βιβλίου
![Screenshot_1](https://user-images.githubusercontent.com/59845451/226200965-d9807e4d-0d6d-498a-8e83-c52516aa28cb.png)

- Φιλτρο comment.lua
![Screenshot_5](https://user-images.githubusercontent.com/59845451/226203256-e5fb4860-dd4c-4449-804a-8e4710c662c2.png)


- make-latex.sh
![Screenshot_3](https://user-images.githubusercontent.com/59845451/226202900-d919d38a-0f25-40f3-9e48-15861fbe52c1.png)

- comment.md
![Screenshot_4](https://user-images.githubusercontent.com/59845451/226202930-27bc2d31-d1ef-42e2-ac63-3080824dce99.png)
